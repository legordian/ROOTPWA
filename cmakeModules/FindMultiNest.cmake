...
if(NOT MultiNest_DIR)
	...
	if(NOT MultiNest_LIBS)
		set(MultiNest_FOUND FALSE)
		set(MultiNest_ERROR_REASON "${MultiNest_ERROR_REASON} Cannot find libconfig library '${_MultiNest_LIB_NAMES}'.")
	else()
	...
	if(NOT _MultiNest_HEADER_FILE)
		set(MultiNest_FOUND FALSE)
		set(MultiNest_ERROR_REASON "${MultiNest_ERROR_REASON} Cannot find libconfig header file '${_MultiNest_HEADER_FILE_NAME}'.")
	endif()
	unset(_MultiNest_HEADER_FILE_NAME)
	unset(_MultiNest_HEADER_FILE)

	if(NOT MultiNest_FOUND)
		set(MultiNest_ERROR_REASON "${MultiNest_ERROR_REASON} MultiNest not found in system directories (and environment variable LIBCONFIG is not set).")
	endif()
